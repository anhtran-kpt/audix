...
export const Header = () => {
  ...
  return (
    <header
      className={cn(
        "sticky left-0 top-0 z-10 w-full h-(--header-height) flex items-center justify-between gap-4 lg:gap-6 py-3 px-6 md:px-8 lg:px-10 xl:px-12 group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)",
